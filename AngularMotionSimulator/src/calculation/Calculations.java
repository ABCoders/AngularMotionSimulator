...
public class Calculations{
	...
	public void update() {
		...
		if(this.calculate()){
			...
			new ErrorDialog((JFrame)SwingUtilities.getWindowAncestor(processFrame), "<html>Cannot calculate using current givens. Please enter givens that can actually be used to do the calculation.</html>");
		}
	}
}
